...
export const FacelessVideo: React.FC<FacelessVideoProps> = ({
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: "#111122" }}>
      ...
      <style>
        {`
          @import url('https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,800;0,900;1,800&family=Oswald&display=swap');
          
          .hook-text {
            background: linear-gradient(90deg, #00FFFF 0%, #0000FF 100%);
        ...
        {currentTime < 2 && title && (
          <div
            ...
            style={{
              ...
              fontWeight: 900,
              fontFamily: "'Oswald', cursive", // Font unik
